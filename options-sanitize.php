...
//add_filter('of_sanitize_social', 'of_sanitize_social', 10, 2);
...
//function of_sanitize_social($input, $option) {
//    $output = '';
//    if (is_array($input)) {
//        foreach ($option['options'] as $key => $value) {
...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __('No Repeat', 'jewelux'),
		'repeat-x'  => __('Repeat Horizontally', 'jewelux'),
		'repeat-y'  => __('Repeat Vertically', 'jewelux'),
		'repeat'    => __('Repeat All', 'jewelux'),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __('Top Left', 'jewelux'),
		'top center'    => __('Top Center', 'jewelux'),
		'top right'     => __('Top Right', 'jewelux'),
		'center left'   => __('Middle Left', 'jewelux'),
		'center center' => __('Middle Center', 'jewelux'),
		'center right'  => __('Middle Right', 'jewelux'),
		'bottom left'   => __('Bottom Left', 'jewelux'),
		'bottom center' => __('Bottom Center', 'jewelux'),
		'bottom right'  => __('Bottom Right', 'jewelux')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __('Scroll Normally', 'jewelux'),
		'fixed'  => __('Fixed in Place', 'jewelux')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __('Normal', 'jewelux'),
		'italic'      => __('Italic', 'jewelux'),
		'bold'        => __('Bold', 'jewelux'),
		'bold italic' => __('Bold Italic', 'jewelux')
		);
